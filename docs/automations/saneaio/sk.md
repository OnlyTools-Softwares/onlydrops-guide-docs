...
### SETTING PROXIES (Alternative IPs to avoid blocks)

From the previous page or any other page, clicking on the **WIFI ICON,** will take you to the proxy settings page.

![Screenshot 2023-02-14 at 4.53.53 PM.png](../../assets/Screenshot 2023-02-14 at 4.52.41 PM.png)
...
![Screenshot 2023-02-14 at 4.53.53 PM.png)
...
![Screenshot 2023-02-15 at 11.22.56 AM (1).png](../../assets/Screenshot 2023-02-14 at 5.15.19 PM.png" alt=""><figcaption></figcaption></figure>
...
![Screenshot 2023-02-15 at 11.22.56 AM (1).png)
...
!!! info
**NOTE:** If you do not start the Captcha Task, the **SK (Safe)** **task** will use in-task generation to fetch Captcha Tokens (slower).&#x20;




![Screenshot 2023-08-03 at 12.30.41 AM.png" alt=""><figcaption></figcaption></figure>

![Screenshot 2023-08-03 at 12.30.55 AM.png](../../assets/Screenshot 2023-08-03 at 12.30.41 AM.png" alt=""><figcaption></figcaption></figure>

![Screenshot 2023-08-03 at 12.30.55 AM.png)
...
!!! info
**NOTE**: If you leave the Size/Variant/CaptchaQty field in the SK (Safe) task empty, it defaults to using **RA (Random)** size during size selection step.
...
![Webhook Sample at Task Success (Successful Checkout](../../assets/Screenshot 2023-08-03 at 2.13.29 AM.png))
...
**1)  line 701 Token Error / location (on Submitting Shipping).**
...
**2) tlsClient Exception or Similar Errors**
